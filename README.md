...
- 修复北京回程路由测试必然失败的问题
- 修复并发下载进度显示进程无法停止的问题
- 修复文件下载失败后无法正确切换备用下载源的问题
- 修复非 Debian/Ubuntu 系统执行无效修复命令的问题
- 修复内核优化在配置文件不存在时静默跳过的问题
- 修复 CentOS/RedHat 未知版本导致脚本强制退出的问题
- 修复脚本自更新后无法正确重启的问题
- 修复参数模式下弹出交互提示导致脚本永久挂起的问题
- 修复 i386 架构下回程路由测试失败的问题
- 修复磁盘信息在总量大于 1GiB 时单位显示错误的问题
- 修复已用内存显示数值偏低的问题
- 修复 IP 质量检测英文模式无法生效的问题
- 修复自定义 IP 质量检测重复安装依赖及颜色显示异常的问题
